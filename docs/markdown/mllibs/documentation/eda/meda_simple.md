...
The purpose of this module is to provide the simple exploratory data analysis operations surrounding **pandas** dataframes
...
/src/eda/meda_simple.json

<h4>module activation functions:</h4>

/src/eda/meda_simple.py
