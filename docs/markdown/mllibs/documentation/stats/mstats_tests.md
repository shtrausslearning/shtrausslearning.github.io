...
The purpose of this module is to provide the user with the ability to conduct data sample tests that are available in **statsmodels** and **scipy.stats** libraries. The module requires **list or parameter value** for sample comparison to test statistical hypotheses and is not aimed at dataframe based data
...
## :material-import: **Requirements** (not updated)
...
## :material-selection-drag: **Selection** (not updated)
