...
### :material-label-variant-outline: <b><span style='color:#FFCA58;text-align:center'></span>NER with Natasha</b>
...
In this notebook, we look at how to utilise the **natasha** library to do predefined **NER**  tagging. 
